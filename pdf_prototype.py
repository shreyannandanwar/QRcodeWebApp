...
class QRCodeGenerator:
  ...
  def save_file(self, img, filename, file_type):
      ...
      # Create a PDF file
    c = canvas.Canvas(f"static/{filename}.pdf", pagesize=letter)
...
if __name__ == "__main__":
  ...
  qrcode_image = qrcode_generator.generate_qrcode(text="iesvakabksvnjlbwg",
  ...
  if qrcode_image:
    # filename = qrcode_generator.file_name_generator("pdf")
    # qrcode_generator.save_file(qrcode_image, filename, "pdf")
    print(f"QR code PDF saved as {qrcode_image}")
